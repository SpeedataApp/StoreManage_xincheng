package com.wenyankeji.wheelview.views;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF00A8EC;

	/** Items text color */
	// private static final int ITEMS_TEXT_COLOR = 0xFF000000;
	private static final int ITEMS_TEXT_COLOR = 0xFF9A9A9A;
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		if (maxLength > 0) {
//			float textWidth = FloatMath.ceil(Layout.getDesiredWidth("中",
//					itemsPaint));
			float textWidth = (float) Math.ceil(Layout.getDesiredWidth("中",
					itemsPaint));
